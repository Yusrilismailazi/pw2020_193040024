...
<html lang="en">
  ...
  <body style="background-image: url(../image/ubah1.jpg); background-position: -100px; height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover">">
